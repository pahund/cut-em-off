...
/* harmony default export */ __webpack_exports__["default"] = (class {
    constructor(map, pubsub) {
        ...
        this.pubsub = pubsub;
        this.bombs = [];
        this.pubsub.subscribe(_pubsub__WEBPACK_IMPORTED_MODULE_0__["DROP_BOMB"], mapCoords => this.dropBomb(mapCoords));
    }
    dropBomb(mapCoords) {
...
/*!***********************!*\
  !*** ./src/config.js ***!
  \***********************/
/*! exports provided: canvasWidth, canvasHeight, tileWidth, tileHeight, mapWidth, mapHeight, mapPaddingX, mapPaddingY, playerStartCol, playerStartRow, playerStartDirection, playerSpeed, virusStartCol, virusStartRow, virusStartDirection, virusSpeed, lightGreen, darkGreen, lightBlue, darkBlue, lightRed, darkRed, collisionRadius */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _messageBox__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./messageBox */ "./src/messageBox/index.js");
/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./player */ "./src/player/index.js");
/* harmony import */ var _pubsub__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pubsub */ "./src/pubsub/index.js");
/* harmony import */ var _user__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./user */ "./src/user/index.js");
/* harmony import */ var _virus__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./virus */ "./src/virus/index.js");
/* harmony import */ var _bomb__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./bomb */ "./src/bomb/index.js");
/* global kontra */
...
(async () => {
    const pubsub = new _pubsub__WEBPACK_IMPORTED_MODULE_5__["Pubsub"]();
    ...
    const player = Object(_player__WEBPACK_IMPORTED_MODULE_4__["createPlayer"])(map, pubsub);
...
/* harmony default export */ __webpack_exports__["default"] = (({ map, player, virus, users, messageBox, bombs, pubsub }) => {
    const times = [];
    let fps;
    let shipMoving = true;
    pubsub.subscribe(_pubsub__WEBPACK_IMPORTED_MODULE_2__["DROP_SHIP"], () => (shipMoving = false));
...
/***/ "./src/messageBox/createMessageBox.js":
/*!********************************************!*\
  !*** ./src/messageBox/createMessageBox.js ***!
  \********************************************/
/*! exports provided: default */
...
/*!*********************************!*\
  !*** ./src/messageBox/index.js ***!
  \*********************************/
/*! exports provided: createMessageBox */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _createMessageBox__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createMessageBox */ "./src/messageBox/createMessageBox.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "createMessageBox", function() { return _createMessageBox__WEBPACK_IMPORTED_MODULE_0__["default"]; });
...
/* harmony default export */ __webpack_exports__["default"] = ((map, pubsub) => {
    const player = kontra.sprite({
        ...
        dropping: false,
        update(messageBox) {
            const updated = Object(___WEBPACK_IMPORTED_MODULE_0__["updatePlayer"])(this, pubsub, messageBox);
            ({
        ...
        infect(virus, messageBox) {
            if (Object(_utils__WEBPACK_IMPORTED_MODULE_3__["collides"])(virus, this)) {
                ...
                if (!this.gameOver) {
                    ...
                    pubsub.publish(_pubsub__WEBPACK_IMPORTED_MODULE_2__["GAME_OVER"]);
                }
            }
        }
    });
    pubsub.subscribe(_pubsub__WEBPACK_IMPORTED_MODULE_2__["GAME_OVER"], () => (player.gameOver = true));
    pubsub.subscribe(_pubsub__WEBPACK_IMPORTED_MODULE_2__["DROP_SHIP"], () => (player.dropping = true));
    return player;
});
...
/* harmony default export */ __webpack_exports__["default"] = ((sprite, pubsub, messageBox) => {
    ...
    if (nextDirection && Object(_directions__WEBPACK_IMPORTED_MODULE_0__["directionIsAllowed"])(map, { x, y }, nextDirection)) {
        ...
        try {
            ...
            if (message === 'dropped') {
                pubsub.publish(_pubsub__WEBPACK_IMPORTED_MODULE_1__["DROP_SHIP"]);
            }
        }
    }
    if (dropBomb) {
        pubsub.publish(_pubsub__WEBPACK_IMPORTED_MODULE_1__["DROP_BOMB"], Object(_utils__WEBPACK_IMPORTED_MODULE_3__["calculateRowAndCol"])(map));
        dropBomb = false;
    }
    return { direction, nextDirection, dropBomb, scale };
});
...
/* harmony default export */ __webpack_exports__["default"] = (class {
    constructor(map, pubsub) {
        ...
        this.pubsub.subscribe(_pubsub__WEBPACK_IMPORTED_MODULE_4__["GAME_OVER"], () => (this.gameOver = true));
    }
    update() {
    ...
    infect(viruses, messageBox) {
        ...
        if (Object(_utils__WEBPACK_IMPORTED_MODULE_3__["allInfected"])(users)) {
            ...
            pubsub.publish(_pubsub__WEBPACK_IMPORTED_MODULE_4__["GAME_OVER"]);
            return;
        }
