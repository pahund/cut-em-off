/*
 * Kontra.js v4.0.0 (Custom Build on 2018-08-13) | MIT
        ...
        return {
            ...
            _g(object) {
                ...
                let intersectsBottomQuadrants =
                    object.y + object.height >= horizontalMidpoint && object.y < this.bounds.y + this.bounds.height;
...
(function() {
    ...
    kontra.tileEngine = function(properties) {
        ...
        let tileEngine = {
            ...
            changeTile(layerName, index, tile) {
                this.layers[layerName].data[index] = tile;
                preRenderImage();
            },
